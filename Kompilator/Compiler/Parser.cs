...
public enum Tokens {error=2,EOF=3,Program=4,OpenBlock=5,Eof=6,
    ...
    Read=37,Write=38,Hex=39,Return=40,Identificator=41,IntNumber=42,
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[7] = new State(new int[]{8,108,10,109,9,110,7,-11,41,-11,23,-11,28,-11,29,-11,30,-11,31,-11,32,-11,42,-11,43,-11,44,-11,37,-11,38,-11,40,-11,34,-11,36,-11,5,-11},new int[]{-23,8,-4,101,-1,102});
    states[8] = new State(new int[]{7,9,41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,37,71,38,76,40,82,34,84,36,92,5,98},new int[]{-5,10,-6,11,-13,13,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51,-10,70,-11,75,-12,81,-7,83,-8,91,-9,97});
    ...
    states[15] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54},new int[]{-13,16,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[16] = new State(-30);
    states[17] = new State(new int[]{14,18,15,68,12,-31,33,-31,11,-31});
    states[18] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-15,19,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[19] = new State(new int[]{16,20,17,43,18,59,19,61,20,63,21,65,14,-32,15,-32,12,-32,33,-32,11,-32});
    states[20] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,21,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[21] = new State(new int[]{22,22,23,45,16,-35,17,-35,18,-35,19,-35,20,-35,21,-35,14,-35,15,-35,12,-35,33,-35,11,-35});
    states[22] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-17,23,-18,57,-19,56,-20,38,-21,51});
    states[23] = new State(new int[]{24,24,25,47,22,-42,23,-42,16,-42,17,-42,18,-42,19,-42,20,-42,21,-42,14,-42,15,-42,12,-42,33,-42,11,-42});
    states[24] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-18,25,-19,56,-20,38,-21,51});
    ...
    states[26] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,27,-20,38,-21,51});
    states[27] = new State(-48);
    states[28] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,29,-20,38,-21,51});
    states[29] = new State(-51);
    states[30] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,31,-20,38,-21,51});
    states[31] = new State(-52);
    states[32] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,33,-20,38,-21,51});
    states[33] = new State(-53);
    states[34] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,35,-20,38,-21,51});
    states[35] = new State(-54);
    states[36] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,37,-20,38,-21,51});
    states[37] = new State(-55);
    states[38] = new State(-56);
    states[39] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54},new int[]{-13,40,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    ...
    states[43] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,44,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[44] = new State(new int[]{22,22,23,45,16,-36,17,-36,18,-36,19,-36,20,-36,21,-36,14,-36,15,-36,12,-36,33,-36,11,-36});
    states[45] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-17,46,-18,57,-19,56,-20,38,-21,51});
    states[46] = new State(new int[]{24,24,25,47,22,-43,23,-43,16,-43,17,-43,18,-43,19,-43,20,-43,21,-43,14,-43,15,-43,12,-43,33,-43,11,-43});
    states[47] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-18,48,-19,56,-20,38,-21,51});
    ...
    states[49] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-19,50,-20,38,-21,51});
    ...
    states[59] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,60,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[60] = new State(new int[]{22,22,23,45,16,-37,17,-37,18,-37,19,-37,20,-37,21,-37,14,-37,15,-37,12,-37,33,-37,11,-37});
    states[61] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,62,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[62] = new State(new int[]{22,22,23,45,16,-38,17,-38,18,-38,19,-38,20,-38,21,-38,14,-38,15,-38,12,-38,33,-38,11,-38});
    states[63] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,64,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[64] = new State(new int[]{22,22,23,45,16,-39,17,-39,18,-39,19,-39,20,-39,21,-39,14,-39,15,-39,12,-39,33,-39,11,-39});
    states[65] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-16,66,-17,58,-18,57,-19,56,-20,38,-21,51});
    ...
    states[68] = new State(new int[]{23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,41,55},new int[]{-15,69,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    ...
    states[76] = new State(new int[]{45,80,41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54},new int[]{-13,77,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    ...
    states[85] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54},new int[]{-13,86,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[86] = new State(new int[]{33,87});
    states[87] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,37,71,38,76,40,82,34,84,36,92,5,98},new int[]{-5,88,-6,11,-13,13,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51,-10,70,-11,75,-12,81,-7,83,-8,91,-9,97});
    states[88] = new State(new int[]{35,89,7,-16,41,-16,23,-16,28,-16,29,-16,30,-16,31,-16,32,-16,42,-16,43,-16,44,-16,37,-16,38,-16,40,-16,34,-16,36,-16,5,-16});
    states[89] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,37,71,38,76,40,82,34,84,36,92,5,98},new int[]{-5,90,-6,11,-13,13,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51,-10,70,-11,75,-12,81,-7,83,-8,91,-9,97});
    states[90] = new State(-17);
    states[91] = new State(-14);
    states[92] = new State(new int[]{32,93});
    states[93] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54},new int[]{-13,94,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51});
    states[94] = new State(new int[]{33,95});
    states[95] = new State(new int[]{41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,37,71,38,76,40,82,34,84,36,92,5,98},new int[]{-5,96,-6,11,-13,13,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51,-10,70,-11,75,-12,81,-7,83,-8,91,-9,97});
    states[96] = new State(-18);
    states[97] = new State(-15);
    states[98] = new State(-11,new int[]{-23,99});
    states[99] = new State(new int[]{7,100,41,14,23,28,28,30,29,32,30,34,31,36,32,39,42,52,43,53,44,54,37,71,38,76,40,82,34,84,36,92,5,98},new int[]{-5,10,-6,11,-13,13,-14,17,-15,42,-16,67,-17,58,-18,57,-19,56,-20,38,-21,51,-10,70,-11,75,-12,81,-7,83,-8,91,-9,97});
    ...
    rules[7] = new Rule(-4, new int[]{-1,-26,-2,41,12});
    rules[8] = new Rule(-2, new int[]{-2,41,11});
    ...
    rules[24] = new Rule(-10, new int[]{37,41});
    rules[25] = new Rule(-10, new int[]{37,41,11,39});
    rules[26] = new Rule(-11, new int[]{38,-13});
    rules[27] = new Rule(-11, new int[]{38,-13,11,39});
    rules[28] = new Rule(-11, new int[]{38,45});
    rules[29] = new Rule(-12, new int[]{40});
    rules[30] = new Rule(-13, new int[]{41,13,-13});
    ...
    rules[59] = new Rule(-21, new int[]{42});
    rules[60] = new Rule(-21, new int[]{43});
    rules[61] = new Rule(-21, new int[]{44});
